...
if(isset($_POST['submit']))
    {   
        ...
        $Level= $_POST['Level'];
        $sql = "UPDATE languages SET Language='$Language',Level='$Level' WHERE id= $id;";
            ...
            <div class="card-header">
                ...
                <form method="POST" enctype="multipart/form-data">                      
                    <div class="from group">
                        ...
                        <input type="text" name="Language" class="from-control" require value="<?php echo $result['Language']; ?>">
                     </div>  
