...
if(isset($_POST['submit']))
    {   
        ...
        $sql = "UPDATE education SET Title='$Title',School='$School',Time='$Time',Description='$Description' WHERE id= $id;";
            ...
            <div class="card-header">
                ...
                <form method="POST" enctype="multipart/form-data">                      
                    ...
                    <div class="from group">
                            ...
                            <input type="text" name="School" class="from-control" require value="<?php echo $result['School']; ?>">
                     </div>
                     <div class="from group">
