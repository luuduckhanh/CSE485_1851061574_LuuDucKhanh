...
if ($result =mysqli_query($dbcon,$sql))
{
    ...
    {   
        ...
        $sql= "INSERT INTO  education(Title,School,Time,Description,UserID )
        values ('$Title','$School','$Time','$Description',$id) ";
                ...
                <div class="card-body">
                   <form method="POST" enctype="multipart/form-data">
                        <div class="from group">
                            ...
                            <input type="text" name="Title" class="from-control" require>
                        </div>
                        <div class="from group">
                            <label for="">School</label>
                            <input type="text" name="School" class="from-control" require>
                        </div>
                        <div class="from group">
                            <label for="">Time</label>
                            <input type="text" name="Time" class="from-control" require>
                        </div>
                        <div class="from group">
                            <label for="">Description</label>
                            <textarea class="form-control" style="width:600px;" rows="5" name="Description" require></textarea>
                        </div>
