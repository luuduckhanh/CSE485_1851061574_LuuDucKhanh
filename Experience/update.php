...
if(isset($_POST['submit']))
    {   
        ...
        $sql = "UPDATE experience SET Title='$Title',Work_Place='$Work_Place',Time='$Time',Description='$Description' WHERE id= $id;";
        ...
        <div class="row">
            ...
            <div class="card-header">
                ...
                <form method="POST" enctype="multipart/form-data">                      
                    ...
                    <div class="from group">
                            <label for="">Work Place</label><br>
                            <input type="text" name="Work_Place" class="from-control" require value="<?php echo $result['Work_Place']; ?>">
                     </div>
                     <div class="from group">
